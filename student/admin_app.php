    ...
    <div class="modal-dialog" role="document">
      ...
      <input type="hidden" name="grad_image_data" id="grad_image_data">
       ...
       <div class="row justify-content-center"><div class="col-md-10">
        <h1 class="h3 mb-4 text-gray-800">Admin Scholarship <br>Application Form</h1>
                  ...
                  <ul class="list-group d-flex justify-content-center">
                    <li class="list-group-item" data-toggle="modal" data-target="#certModal" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ml-4">Certificate of Employment</span>
                    ...
                    <li class="list-group-item" data-toggle="modal" data-target="#moralModal" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ml-4">Photocopy of PSA</span>
                            <i class="fas fa-upload ml-auto"></i>
                        </div>
                    </li>
                </ul>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <div>
                                ...
                                <p class="requirement-name">Certificate of Employment</p>
                            </div>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                            <input type="file" class="form-control-file" name="coe_file" id="certFile" accept="image/*">
                            </div>
                        </div>
                        <div class="modal-footer">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <div> 
                          <h5 class="modal-title">Requirements</h5>
                           <p class="requirement-name">Photocopy of PSA</p>
                       </div>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                        <div class="modal-body">
                            <div class="form-group">
                            <input type="file" class="form-control-file" name="psa_file" id="moralFile" accept="image/*">
