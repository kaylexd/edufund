 ...
 <div class="container-fluid">
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-4">
                ...
                <input type="text" name="sschool" id="sschool" placeholder="Put N/A if None" class="form-control" />
                <span id="error_sschool" class="text-danger"></span>
              </div>
              <div class="col-xs-12 col-sm-12 col-4">
                <label>Award Received</label>
                <input type="text" name="saward" id="saward" placeholder="Put N/A if None" class="form-control">
                <span id="error_saward" class="text-danger"></span>
              </div>
              <div class="col-xs-10 col-sm-12 col-4">
                <label>Date Received<span class="text-danger">*</span></label>
                <input type="date" name="sreceive" id="sreceive" autocomplete="off" class="form-control" />
    ...
    <div class="tab-pane" id="require_details">
            ...
            <div class="card">
              <div class="card-header" style="font-weight: bold; font-size: 16px;">List of Requirements</div>
                <div class="card-body">
                  <div class="form-group">
                  <ul class="list-group d-flex justify-content-center">
                    <li class="list-group-item" data-toggle="modal" data-target="#certModal" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            <input type="checkbox" class="form-check-input ml-2" id="certCheck" disabled>
                            <span class="ml-4">Photocopy of Certificate of Honor</span>
                    ...
                    <li class="list-group-item" data-toggle="modal" data-target="#gradesModal" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ml-4">Photocopy of Gr. 12, 2nd Sem. Grades</span>
                            <i class="fas fa-upload ml-auto"></i>
                        </div>
                    </li>
                    <li class="list-group-item" data-toggle="modal" data-target="#gradModal" style="cursor: pointer;">
                        <div class="d-flex align-items-center">
                            <input type="checkbox" class="form-check-input ml-2" id="gradCheck" disabled>
                            <span class="ml-4">Graduation Program</span>
                            <i class="fas fa-upload ml-auto"></i>
                        </div>
                    </li>
                </ul>
            ...
            <!-- Modal for Certificate of Honor -->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <div>
                                ...
                                <p class="requirement-name">Photocopy of Certificate of Honor</p>
                            </div>
                      ...
                      <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="file" class="form-control-file" name="moral_file" id="moralFile" accept="image/*">
                                <img id="certPreview" class="img-fluid mt-2" style="display: none;">
                            </div>
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div> 
                                <h5 class="modal-title">Requirements</h5>
                                <p class="requirement-name">Photocopy of Gr. 12, 2nd Sem. Grades</p>
                            </div>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            ...
                            <input type="file" class="form-control-file" name="grades_file" id="gradesFile" accept="image/*">
                                <img id="gradesPreview" class="img-fluid mt-2" style="display: none;">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            <!-- Modal for Graduation Program -->
            <div class="modal fade" id="gradModal" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div> 
                                <h5 class="modal-title">Requirements</h5>
                                <p class="requirement-name">Graduation Program</p>
                            </div>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                            <input type="file" class="form-control-file" name="grad_file" id="gradFile" accept="image/*">
                                <img id="gradPreview" class="img-fluid mt-2" style="display: none;">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$('input[type="file"]').change(function(e) {
  ...
  // Achievement Details
        $('#btn_achievement_details').click(function(){
          ...
          if($.trim($('#sschool').val()).length == 0)
          {
          error_sschool = 'Student GWA is required';
          $('#error_sschool').text(error_sschool);
          $('#sschool').addClass('has-error');
          }
          else
          {
          error_sschool = '';
          $('#error_sschool').text(error_sschool);
          $('#sschool').removeClass('has-error');
          }
          if($.trim($('#saward').val()).length == 0)
          {
          error_saward = 'Student Award is required';
          $('#error_saward').text(error_saward);
          $('#saward').addClass('has-error');
          }
          else
          {
          error_saward = '';
          $('#error_saward').text(error_saward);
          $('#saward').removeClass('has-error');
          }

          if($.trim($('#sreceive').val()).length == 0)
          {
          error_sreceive = 'Date Received is required';
          $('#error_sreceive').text(error_sreceive);
          $('#sreceive').addClass('has-error');
          }
          else
          {
          error_sreceive = '';
          $('#error_sreceive').text(error_sreceive);
          $('#sreceive').removeClass('has-error');
          }
